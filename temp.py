...
st.caption("🚀 AzureChatOpenAI-Powered Streamlit Chatbot for Enterprise Data Exploration")
...
if prompt := st.chat_input():
    ...
    if prev_response:
        ...
        sql_prompt = f"""
        You are a summarizer, Use the following inforation and summarize the data: 
        Make sure the aggregates of the summary should always be mathematically accurate.
        DataFrame: {tabular_data}
        Question: {prompt}
        Instructions:
        1.The data pertains to Adventure Works Cycles, a company that manufactures and sells bicycles, bicycle parts, and accessories. The AI assists in analyzing this data as an analyst would.
        2.If the user's question is not related to Adventure Works Cycles, its products, or finances, mention this in your response. However, still summarize the tables provided in this prompt.
        3.If tabular data or dataframe is empty, with no columns or index or If the user's question is not relevant to Adventure Works Cycles, ask clarifying questions to better understand their needs.
        """    
